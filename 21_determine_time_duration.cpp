//Here we will calculate time duration to calculate pie and will check how multithreading improve performance
...
int main(int argc, char** argv) {
    ...
    //cout<<"PI:  "<<M_PI<<endl;
    cout<<setprecision(15)<<"SUM: "<<sum<<" Time taken: "<<milliseconds<<endl;
